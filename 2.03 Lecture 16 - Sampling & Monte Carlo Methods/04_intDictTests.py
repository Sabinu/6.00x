...
print('1000 buckets with  50 insertions: {:.3f}'.format(round(collision_prob(1000,  50), 3)))
print('1000 buckets with 200 insertions: {:.3f}'.format(round(collision_prob(1000, 200), 3)))

print(observe_prob(1000,  50, 1000))
print(observe_prob(1000, 200, 1000))

print('Birthday Probability for  30 students:', collision_prob(365,  30))
print('Birthday Probability for 250 students:', collision_prob(365, 250))


def itsearch_birth_probability():
    st_num = 1
    while collision_prob(365, st_num) < 0.99:
        st_num += 1
    return st_num - 1


print('Minimum Birthday Probability:', itsearch_birth_probability())